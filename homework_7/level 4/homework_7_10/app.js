...
function showCategory(category) {
    ...
    categoryProduct.forEach(function (product) {
        finalMarkup = finalMarkup + getProductMarkup(product);
    })
    productsEl.insertAdjacentHTML("afterbegin", finalMarkup);
}
...
function getProductMarkup(product) {
    return `
            <div class="product">
                ...
                <a href="https://example.com/producs/${product.id}" alt="pic${product.id}">Подробнее</a>
            </div>
        `;
}
